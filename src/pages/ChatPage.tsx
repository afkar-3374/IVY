...
const ChatPage: React.FC = () => {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`flex-1 min-h-0 flex flex-col h-full overflow-hidden relative ${getWallpaperClass()}`}
    ...
    >
      ...
      <div
        ...
        className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 space-y-3 relative"
      >
